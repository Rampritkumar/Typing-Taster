...
const easy = () =>{
    ...
    // acticle for typing 
    const article = [
        " easy  Frank Edward McGurrin, a court stenographer from Salt Lake City, Utah who taught typing classes, reportedly invented touch typing in ",
        " vikash The keyboard is called a QWERTY keyboard because these are the first six letters on the keyboard. Most modern computer keyboards have a raised dot or bar on the home keys for the",
        " sonu The truth is that almost any single word could be a quote given the correct context. Many of the one word quotes found in our generator database are sayings that you might hear when someone is describing someone they admire or who is doing well. A lot of people who use this tool do so in order to find the perfect one word quotes they want to post to their social media accounts for the day. It's a wonderful way to find good 1 word phrases to post that expresses your feelings and frame of mind for the day.",
        " sarvesh We hope that you've found this one word quotes tool useful. We are always looking for ways to better our tools and to make them more useful for those who find and use them. If you found this generator to be useful, we'd love to hear from you on how you used it. Hearing from users helps us to make improvements to the tool when we make updates. We'd also be quite interested in hearing any suggestions you might have on ways we can make the one word quotes generator better."
    ];
